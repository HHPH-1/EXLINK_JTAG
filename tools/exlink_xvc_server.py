...
def shift_via_bridge(
    ...
    return mask_unused_high_bits(tdo, bit_count), chunks
    ...
    try:
        while True:
            ...
            if command == b"shift:":
                ...
                tdo, chunks = shift_via_bridge(bridge, bit_count, tms, tdi, args.firmware_max_shift_bits)
                stats.record_shift(bit_count)
